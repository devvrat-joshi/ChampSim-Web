...
urlpatterns = [
    ...
    path('build_champsim.sh', views.build, name = "build_champsim.sh"),
    path('run_champsim.sh', views.run, name = "run_champsim.sh"),
    path('building', views.jsonbuild, name = "building"),
    path('BP_editor_champsim',views.edit,name="BP_editor_champsim"),
